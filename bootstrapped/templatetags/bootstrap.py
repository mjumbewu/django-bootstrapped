...
def bootstrap_custom_less(less):
    output=[
            '<link rel="stylesheet" type="text/less" href="%sless/%s" media="all">' % (settings.STATIC_URL, less),
...
def bootstrap_less():
    output=[
            '<link rel="stylesheet" type="text/less" href="%sless/bootstrap.less">' % settings.STATIC_URL,
